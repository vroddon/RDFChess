...
//    public static final String sparqlq = "http://localhost:3030/RDFChess/query";
    ...
    public static final String sparqlu = "http://localhost:8082/fuseki/RDFChess/update";
    public static final String sparqlq = "http://localhost:8082/fuseki/RDFChess/query";
